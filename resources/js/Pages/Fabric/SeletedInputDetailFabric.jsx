...
export default function SeletedInputDetailFabric(props) {
    const ref = useRef()
    const {
        label = '',
        itemSelected = null,
    ...
    const toggleFormModal = (detailfabric = null) => {
        formModal.setData(detailfabric)
        formModal.toggle()
    }
