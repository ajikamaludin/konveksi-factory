...
export default function Index(props) {
    ...
    const onDelete = () => {
        if(confirmModal.data !== null) {
            router.delete(route('supplier.destroy', confirmModal.data.id))
        }
    }
    ...
    const canCreate = hasPermission(auth, 'create-supplier')
    const canUpdate = hasPermission(auth, 'update-supplier')
    const canDelete = hasPermission(auth, 'delete-supplier')
                                        ...
                                        {data.map(supplier => (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={supplier.id}>
                                                ...
                                                <td className="py-4 px-6 flex justify-end">
                                                    ...
                                                    >
                                                        {canUpdate && (
                                                            <Dropdown.Item onClick={() => toggleFormModal(supplier)}>
